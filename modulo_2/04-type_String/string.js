...
let nomeCompleto = 'Diego de Souza Lima';
console.log(nomeCompleto);
// => exemplo 02 - Double Quotes
let fubcaoEmpresa = "Cloud Advocate em JavaScript";
console.log(fubcaoEmpresa);
// => exemplo 03 Back ticks
let nomeEmpresa = 'Microsoft';
let dadosFuncionario = `Seja bem vindo ${nomeCompleto}! Você será ${fubcaoEmpresa} na ${nomeEmpresa}`;
